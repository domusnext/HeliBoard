...
object Defaults {
    ...
    @JvmField
    val PREF_BOTTOM_PADDING_SCALE = arrayOf(DEFAULT_SIZE_SCALE, 2f)  // [竖屏, 横屏] 横屏底部缩放 200%
    @JvmField
    val PREF_SIDE_PADDING_SCALE = arrayOf(0f, 0.2f, 0f, 0.2f)  // [竖屏, 横屏, 竖屏分离, 横屏分离] 横屏侧边距 20%
    ...
    const val PREF_SPACE_BAR_TEXT = "Space"
